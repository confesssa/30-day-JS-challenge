    ...
    const sortedPeopleList = people.sort((aPerson, bPerson) => aPerson > bPerson ? 1 : -1);
    console.log('The list of the people, sorted alphabetically by last name');
    ...
    console.log('Sum of the instances of each of transport');
